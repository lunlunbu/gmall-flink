...
import com.lunlunbu.bean.UserLoginBean;
...
//        System.setProperty("HADOOP_USER_NAME", "atguigu");
        ...
        String groupId = "dws_user_userLogin_view_window";
        ...
        SingleOutputStreamOperator<JSONObject> jsonObjDS = kafkaDS.flatMap(new FlatMapFunction<String, JSONObject>() {
            ...
            public void flatMap(String value, Collector<JSONObject> out) throws Exception {
                ...
                //当UID不为空且上一跳页面为null或login才是登陆数据
        ...
        SingleOutputStreamOperator<UserLoginBean> resultDS = userLoginDS.windowAll(TumblingEventTimeWindows.of(Time.seconds(10)))
                .reduce(new ReduceFunction<UserLoginBean>() {
                    ...
                    @Override
                    public void apply(TimeWindow window, Iterable<UserLoginBean> value, Collector<UserLoginBean> out) throws Exception {
                        UserLoginBean next = value.iterator().next();
